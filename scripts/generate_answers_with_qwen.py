...
def main():
    ...
    parser.add_argument("--config_path", type=str, 
                        default="/remote-home1/wxzhang/QwenSearchEnhancer/configs/qwen_config.yaml",
                        help="配置文件路径")
    ...
    cmd = [
        "python", 
        os.path.join("/remote-home1/wxzhang/QwenSearchEnhancer/src/data_generation", "test_qwen_ability.py"),
